...
public class SysResult {
     ...
     * @param data 数据
     */
    public SysResult(Integer status, String msg, Object data, Long total) {
        this.status = status;
        this.msg = msg;
        this.data = data;
     ...
     * @return vo
     */
    public static <T> SysResult page(IPage<T> data) {
        return new SysResult(200, "success", data, data.getTotal());
    }
}
